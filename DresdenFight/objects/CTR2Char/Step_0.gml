...
if (gamepad_axis_value(1,gp_axislv) > 0.4 || gamepad_button_check(1,gp_padd) || gamepad_axis_value(5,gp_axislv) > 0.4 || gamepad_button_check(5,gp_padd))
{
	key_duck = 1;
}

if (gamepad_button_check(1,gp_face1) || gamepad_button_check(5,gp_face1) ||  gamepad_button_check(1,gp_shoulderr) || gamepad_button_check(5,gp_shoulderr))
{
	key_jump = 1;
}

if (gamepad_button_check(1,gp_face3) || gamepad_button_check(5,gp_face2) || gamepad_button_check(1,gp_face3) || gamepad_button_check(5,gp_face2) || gamepad_button_check(1,gp_shoulderl) || gamepad_button_check(5,gp_shoulderl))
{
	key_run = 1;
}

if (gamepad_axis_value(1,gp_axislv) < -0.4 || gamepad_button_check(1,gp_padu) || gamepad_axis_value(5,gp_axislv) < -0.4 || gamepad_button_check(5,gp_padu))
{
	key_up = 1;
}
